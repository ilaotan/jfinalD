...
import com.jfinal.ext.plugin.shiro.core.ShiroInterceptor;
import com.jfinal.ext.plugin.shiro.core.ShiroKit;
import com.jfinal.ext.plugin.shiro.core.ShiroPlugin;
...
import com.ilaotan.application.system.model._MappingKit;
import com.ilaotan.framework.handler.SessionIdHandler;
import com.ilaotan.framework.handler.XssHandler;
import com.ilaotan.framework.interceptor.ExceptionIntoLogInterceptor;
import com.ilaotan.framework.interceptor.GlobalInterceptor;
import com.ilaotan.framework.log.LogBackLogFactory;
import com.ilaotan.framework.tio.HelloServerStarter;
...
//        rf.config();
        ...
        Map<String, Object> shared = new HashMap<>(5);
...
//        me.addSharedFunction("_common/common.html");
    ...
    public void configPlugin(Plugins me) {
        ...
        //这是默认的
//		DruidPlugin dpOne = new DruidPlugin(getProperty("jdbc.url"), getProperty("jdbc.username"), getProperty("jdbc
// .password"));
...
///////////////////////////
//
//		DruidPlugin dpTwo = new DruidPlugin(getProperty("jdbc.url2"), getProperty("jdbc.username"), getProperty("jdbc
// .password"));
...
//		 * */
//		DruidPlugin dp2 = new DruidPlugin(PropKit.get("jdbc.url2"), PropKit.get("jdbc.username"), PropKit.get("jdbc
// .password"));
...
//		arp.setCache(new MyRedisCache());
    ...
    public void configInterceptor(Interceptors me) {
        ...
        me.addGlobalActionInterceptor(new SessionInViewInterceptor());//解决session在freemarker中不能取得的问题
