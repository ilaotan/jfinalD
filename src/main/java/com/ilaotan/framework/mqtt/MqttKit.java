package com.ilaotan.framework.mqtt;
...
public class MqttKit {
     ...
     */
    public static boolean sub(String topic, int qos, IMqttMessageListener messageListener, long timeout) throws
            MqttException {
        if (timeout <= -1) {
     ...
     */
    public static boolean pub(String topic, byte[] payload, int qos, boolean retained) throws
     ...
     * @throws MqttPersistenceException
     */
    public static boolean pub(String topic, byte[] payload, int qos, boolean retained, long timeout) throws
            MqttPersistenceException, MqttException {
