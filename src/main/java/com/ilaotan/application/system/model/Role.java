...
import com.ilaotan.application.system.model.base.BaseRole;
...
public class Role extends BaseRole<Role> {
    ...
    public List<String> findRoleByUserId(Long id) {
        List<Role> roleList = super.find("select r.name from system_user_role ur INNER JOIN system_role r on ur" +
                ".role_id = r.id where ur.user_id=?", id);
