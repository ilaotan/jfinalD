package com.ilaotan.application.system.entity;
...
public class TablePage {
    ...
    public String getPageStr() {
        ...
        if (pageNo == first) {// 如果是首页
            ...
            sb.append
                    ("<li><a href=\"javascript:\" onclick=\"" + funcName + "(" + prev + "," + pageSize + ");\">&#171;" +
                            " 上一页</a></li>\n");
        }
...
//		sb.append("<input type=\"text\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e
// .which;if(c==13)");
//		sb.append(funcName+"(this.value,"+pageSize+");\" onclick=\"this.select();\"/> / ");
//		sb.append("<input type=\"text\" value=\""+pageSize+"\" onkeypress=\"var e=window.event||this;var c=e
// .keyCode||e.which;if(c==13)");
