package com.ilaotan.application.system;
...
//		DruidPlugin dp = new DruidPlugin(PropKit.get("jdbc.url"), PropKit.get("jdbc.username"), PropKit.get("jdbc
// .password"));
//		dp.start();
//		return dp.getDataSource();
    ...
    public static void main(String[] args) {
        // base model 所使用的包名
        String baseModelPackageName = "com.ilaotan.application.system.model.base";
        // base model 文件保存路径
        String baseModelOutputDir = PathKit.getWebRootPath() +
                "/src/main/java/com/jfinalD/application/system/model/base";

        // model 所使用的包名 (MappingKit 默认使用的包名)
        String modelPackageName = "com.ilaotan.application.system.model";
