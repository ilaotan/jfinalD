...
public class WeixinApiController extends ApiController {
    ...
    public void getQrcode() {
        String str = "{\"expire_seconds\": 604800, \"action_name\": \"QR_SCENE\", \"action_info\": {\"scene\": " +
                "{\"scene_id\": 123}}}";
        ApiResult apiResult = QrcodeApi.create(str);
        renderText(apiResult.getJson());

//        String str = "{\"action_name\": \"QR_LIMIT_STR_SCENE\", \"action_info\": {\"scene\": {\"scene_str\":
// \"123\"}}}";
...
//        renderText(apiResult.getJson());
    ...
    public void getShorturl() {
        String str = "{\"action\":\"long2short\"," +
                "\"long_url\":\"http://wap.koudaitong" +
                ".com/v2/showcase/goods?alias=128wi9shh&spm=h56083&redirect_count=1\"}";
